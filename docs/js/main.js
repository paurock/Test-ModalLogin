...
var checkForm = function checkForm() {
  ...
  var isValidatedPhone = mobile.match(myRegExpPhone) ? true : false;
  var isValidatedPassword = password.length >= 4 ? true : false;
...
document.querySelector('.modal-login-wrapbox__inputs-phone').addEventListener('keydown', function () {
  return checkForm();
});
document.querySelector('.modal-login-wrapbox__inputs-password').addEventListener('keydown', function () {
  return checkForm();
});
